...
#if !defined(_WIN32)
static void vfree (void *what, uint size)
{
    free (what);
}
#elif defined(_WIN32)
...
//	open judy object
static JudyPtr _judy_open (uint max)
{
JudySeg *seg;
Judy_ *judy;
uint amt;
    ...
    amt = sizeof(Judy_) + max * sizeof(JudyStack);
#ifdef STANDALONE
    MaxMem += JUDY_seg;
#endif
...
static inline void _judy_close (Judy_ *judy)
{
...
//	allocate judy node
static void *judy_alloc (Judy_ *judy, int type)
{
void **block;
JudySeg *seg;
uint amt;
...
static void * _judy_data (Judy_ *judy, uint amt)
{
JudySeg *seg;
void *block;
...
static inline void judy_free (Judy_ *judy, void *block, int type)
{
...
static uint _judy_key (Judy_ *judy, uchar *buff, uint max)
{
...
static judyslot *_judy_slot (Judy_ *judy, uchar *buff, uint max)
{
...
static judyslot *judy_promote (Judy_ *judy, judyslot *next,
                               int idx, judyvalue value,
                               int keysize)
{
...
static void judy_radix (Judy_ *judy, judyslot *radix,
                        uchar *old, int start,
                        int slot, int keysize, uchar key)
{
...
static void judy_splitnode (Judy_ *judy, judyslot *next,
                            uint size, uint keysize)
{
...
static judyslot *judy_first (Judy_ *judy, judyslot next, uint off)
{
...
static judyslot *judy_last (Judy_ *judy, judyslot next, uint off)
{
judyslot *table, *inner;
uint keysize, size;
judyslot *node;
...
static inline judyslot *_judy_end (Judy_ *judy)
{
    judy->level = 0;
...
static judyslot *_judy_nxt (Judy_ *judy)
{
judyslot *table, *inner;
int slot, size, cnt;
judyslot *node;
...
static judyslot * _judy_prv (Judy_ *judy)
{
...
static judyslot *_judy_del (Judy_ *judy)
{
...
static judyslot *_judy_strt (Judy_ *judy, uchar *buff, uint max)
{
judyslot *cell;
    ...
    return _judy_nxt(judy);
}

//	split open span node

static void judy_splitspan (Judy_ *judy, judyslot *next, uchar *base)
{
...
static judyslot *_judy_cell (Judy_ *judy, uchar *buff, uint max)
{
