...
class ZstdUtil{
public:
    static int CompressString(const std::string& src, std::string& dst, int compressionlevel) {
    ...
    static int StreamCompressString(const std::string& src, std::string& dst, int compressionlevel) {
